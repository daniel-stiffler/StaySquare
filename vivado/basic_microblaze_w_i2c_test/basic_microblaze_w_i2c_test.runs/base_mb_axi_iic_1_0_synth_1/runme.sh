...
HD_PWD='/afs/ece.cmu.edu/usr/apinson/Documents/500/vivado/microblaze_HDMI_test/microblaze_HDMI_test.runs/base_mb_axi_iic_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_mb_axi_iic_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_mb_axi_iic_1_0.tcl
